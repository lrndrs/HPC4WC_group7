...
from functions.stencils import test, laplacian
...
@click.option('--stencil_type', type=str, required=True, help='Specify which stencil to use. Options are [test, laplacian]')
...
def main(dim, nx, ny, nz, num_iter, stencil_type, num_halo=2, plot_result=False):
    ...
    stencil_type_list = ["test", "laplacian"]
